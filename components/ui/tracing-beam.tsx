...
export const TracingBeam = ({
  ...
  useEffect(() => {
    if (contentRef.current) {
      ...
      console.log("SVG Height set to:", contentRef.current.offsetHeight);
    }
  }, []);
  ...
  const y2 = useSpring(
    useTransform(scrollYProgress, [0, 1.3], [100, svgHeight - 200]),
    {
      stiffness: 500,
      damping: 90,
    }
    ...
    >
      <div className="absolute left-1/2 transform -translate-x-1/2 top-0">
        ...
        <svg
          ...
          width="20"
          height={svgHeight}
          className="block mt-2" // Adjust alignment
          aria-hidden="true"
        >
          <motion.path
